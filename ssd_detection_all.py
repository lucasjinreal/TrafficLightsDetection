...
def ssd_detection(detect_image, map_label, is_show=True):
    ...
    if len(detect_image.split('/')) != 0:
        image_save_path = './predict_result2/' + detect_image.split('/')[-1]
    else:
        image_save_path = './predict_result2/' + detect_image
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print "this script for detection traffic lights, put the images dir in 2th arguments."
        exit(0)
    ...
    if os.path.isdir(images_dir):
        ...
        for img in images:
            ...
            ssd_detection(img_path, label_map, is_show=False)
    else:
        print "invalid dir."
        exit(0)

    # test images
    # ssd_detection('tl2.jpg', label_map)
