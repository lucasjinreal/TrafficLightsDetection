...
train_data = data_root_dir + "LISA/lmdb/LISA_trainval_lmdb"
# The database file for testing data. Created by data/KITTI/create_data.sh
test_data = data_root_dir + "LISA/lmdb/LISA_test_lmdb"
...
model_name = "VGG_LISA_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/LISA/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/LISA/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/LISA/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/LISA/results/{}/Main".format(os.environ['HOME'], job_name)
...
# Stores LabelMapItem.
label_map_file = "{}/data/labelmap_lisa.prototxt".format(current_dir)
